                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<c:url value='/organization?action=editS' />">Organization Edit</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="<c:url value='/organization?action=edit&ORGANIZATION_SEQ=${resultMap.ORGANIZATION_SEQ}' />">
