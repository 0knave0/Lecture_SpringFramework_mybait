                                    ...
                                    <tbody>
										<c:forEach items="${resultList}" var="resultData" varStatus="loop">
											...
											<td><input type="checkbox" class="checkbox" name="ORGANIZATION_SEQ" value="${resultData.ORGANIZATION_SEQ}" /></td>
												<td>
												<a href="<c:url value='/organization?action=read&ORGANIZATION_SEQ=${resultData.ORGANIZATION_SEQ}' />">
												${resultData.ORGANIZATION_SEQ}</a>
												</td>
												<td>
												<a href="<c:url value='/organization?action=delete&ORGANIZATION_SEQ=${resultData.ORGANIZATION_SEQ}' />">
												${resultData.NAME}</a>
												</td>
